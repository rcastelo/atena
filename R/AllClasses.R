...
#' it uses the available secondary alignments to implement an analogous approach
#' to that of the third ERVmap filter. When \code{suboptimalAlignmentTag="none"},
#' it also performs the latter approach even when the tag \code{XS} is available.
