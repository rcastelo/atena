...
barplot(table(mcols(rmskat)$status), las = 2, cex.names = 0.7,
        main = "TEs by status", cex=0.6, border = "white")
...
```
```{r comparsedann, message=FALSE, height=6, width=10, out.width="800px", fig.cap="Composition of parsed TE annotations."}
