...
Here, the Telescope annotations will be used and TE quantifications will be aggregated according to the `names()` of the `annot_tel` object.

```{r}
bamfiles <- list.files(system.file("extdata", package="atena"),
                       pattern="*.bam", full.names=TRUE)
annot_tel <- Telescope_ann(type = "all", version = "hg38")
tspar <- TelescopeParam(bfl=bamfiles, teFeatures=annot_tel,
